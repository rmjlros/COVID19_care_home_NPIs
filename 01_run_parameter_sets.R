...
if (scenario_staff_other_LTCF == "change_p_working_another_LTCF") {
  changed_p_working_another_LTCF <- 0
}
...
if (scenario_delay_isolation == "change") {
  changed_delay_isolation <- 0.25
  changed_delay_isolation_c <- 1
} # changes delay_isolation to this value
...
if (scenario_delay_isolation == "change") {
  changed_delay_isolation <- 0.25
  changed_delay_isolation_c <- 0.25
} # changes delay_isolation to this value
