...
n_V <- if (n_V_mean == 0) {
  ...
  rbeta(n.sim, (((1 - n_V_mean) / 0.1^2 - 1 / n_V_mean) * n_V_mean^2), ((((1 - n_V_mean) / 0.1^2 - 1 / n_V_mean) * n_V_mean^2) * (1 / n_V_mean - 1)))
}
...
# R0 in the community
R0_community <- if (R0_community_mean == 0) {
  rep(0, n.sim)
} else {
  rgamma(n.sim, shape = 16, scale = R0_community_mean / 16)
}
...
p_LTCF2_outbreak <- if (p_LTCF2_outbreak_mean == 0) {
  rep(0, n.sim)
} else {
  rbeta(n.sim, (((1 - p_LTCF2_outbreak_mean) / 0.02^2 - 1 / p_LTCF2_outbreak_mean) * p_LTCF2_outbreak_mean^2), ((((1 - p_LTCF2_outbreak_mean) / 0.02^2 - 1 / p_LTCF2_outbreak_mean) * p_LTCF2_outbreak_mean^2) * (1 / p_LTCF2_outbreak_mean - 1)))
}
...
p_working_another_LTCF <- if (p_working_another_LTCF_mean == 0) {
  rep(0, n.sim)
} else {
  rbeta(n.sim, (((1 - p_working_another_LTCF_mean) / 0.005^2 - 1 / p_working_another_LTCF_mean) * p_working_another_LTCF_mean^2), ((((1 - p_working_another_LTCF_mean) / 0.005^2 - 1 / p_working_another_LTCF_mean) * p_working_another_LTCF_mean^2) * (1 / p_working_another_LTCF_mean - 1)))
}
...
m_i <- if (m_i_mean == 0) {
  ...
  rbeta(n.sim, (((1 - m_i_mean) / 0.15^2 - 1 / m_i_mean) * m_i_mean^2), ((((1 - m_i_mean) / 0.15^2 - 1 / m_i_mean) * m_i_mean^2) * (1 / m_i_mean - 1)))
}
...
p_tnc <- if (p_tnc_mean == 0) {
  rep(0, n.sim)
} else if (p_tnc_mean == 1) {
  rep(1, n.sim)
} else {
  rbeta(n.sim, (((1 - p_tnc_mean) / 0.05^2 - 1 / p_tnc_mean) * p_tnc_mean^2), ((((1 - p_tnc_mean) / 0.05^2 - 1 / p_tnc_mean) * p_tnc_mean^2) * (1 / p_tnc_mean - 1)))
}
...
p_tc <- if (p_tc_mean == 0) {
  ...
  rbeta(n.sim, (((1 - p_tc_mean) / 0.05^2 - 1 / p_tc_mean) * p_tc_mean^2), ((((1 - p_tc_mean) / 0.05^2 - 1 / p_tc_mean) * p_tc_mean^2) * (1 / p_tc_mean - 1)))
}

# probability of STAFF being tested if not symptomatic with COVID-19
p_tncs <- if (p_tncs_mean == 0) {
  rep(0, n.sim)
} else if (p_tncs_mean == 1) {
  rep(1, n.sim)
} else {
  rbeta(n.sim, (((1 - p_tncs_mean) / 0.05^2 - 1 / p_tncs_mean) * p_tncs_mean^2), ((((1 - p_tncs_mean) / 0.05^2 - 1 / p_tncs_mean) * p_tncs_mean^2) * (1 / p_tncs_mean - 1)))
}
...
p_fn <- if (p_fn_mean == 0) {
  ...
  rbeta(n.sim, (((1 - p_fn_mean) / 0.05^2 - 1 / p_fn_mean) * p_fn_mean^2), ((((1 - p_fn_mean) / 0.05^2 - 1 / p_fn_mean) * p_fn_mean^2) * (1 / p_fn_mean - 1)))
}

# probability of having a false-negative test in hospital
p_fn_h <- if (p_fn_h_mean == 0) {
  rep(0, n.sim)
} else if (p_fn_h_mean == 1) {
  rep(1, n.sim)
} else {
  rbeta(n.sim, (((1 - p_fn_h_mean) / 0.01^2 - 1 / p_fn_h_mean) * p_fn_h_mean^2), ((((1 - p_fn_h_mean) / 0.01^2 - 1 / p_fn_h_mean) * p_fn_h_mean^2) * (1 / p_fn_h_mean - 1)))
}
...
p_i <- if (p_i_mean == 0) {
  ...
  rbeta(n.sim, (((1 - p_i_mean) / 0.08^2 - 1 / p_i_mean) * p_i_mean^2), ((((1 - p_i_mean) / 0.08^2 - 1 / p_i_mean) * p_i_mean^2) * (1 / p_i_mean - 1)))
}
...
CFR <- if (CFR_mean == 0) {
  ...
  rbeta(n.sim, (((1 - CFR_mean) / 0.08^2 - 1 / CFR_mean) * CFR^2), ((((1 - CFR_mean) / 0.08^2 - 1 / CFR_mean) * CFR^2) * (1 / CFR_mean - 1)))
}
...
p_EIpcIa_hosp <- if (p_EIpcIa_hosp_mean == 0) {
  rep(0, n.sim)
} else if (p_EIpcIa_hosp_mean == 1) {
  rep(1, n.sim)
} else {
  rbeta(n.sim, (((1 - p_EIpcIa_hosp_mean) / 0.001^2 - 1 / p_EIpcIa_hosp_mean) * p_EIpcIa_hosp_mean^2), ((((1 - p_EIpcIa_hosp_mean) / 0.001^2 - 1 / p_EIpcIa_hosp_mean) * p_EIpcIa_hosp_mean^2) * (1 / p_EIpcIa_hosp_mean - 1)))
}
...
theta_matrix_rates <- rbind(
  delta,
  kappa,
  n_V
)

theta_matrix_other <- rbind(
  d_latency,
  d_pc_inf,
  d_c_inf,
  p_a,
...
theta_matrix_rates_ll <- rbind(
  delta_ll,
  kappa_ll,
  n_V_ll
)

theta_matrix_other_ll <- rbind(
  d_latency_ll,
  d_pc_inf_ll,
  d_c_inf_ll,
  p_a_ll,
...
theta_matrix_fixed_ll <- rbind(
  rho_ll = rep(rho_ll, n.sim),
...
theta_matrix_rates_ul <- rbind(
  delta_ul,
  kappa_ul,
  n_V_ul
)

theta_matrix_other_ul <- rbind(
  d_latency_ul,
  d_pc_inf_ul,
  d_c_inf_ul,
  p_a_ul,
...
theta_matrix_fixed_ul <- rbind(
  rho_ul = rep(rho_ul, n.sim),
